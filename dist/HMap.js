...
exports.Style = exports.LayerSwitcher = exports.Feature = exports.Layer = exports.proj4 = exports.ol = exports.ee = exports.a = exports.PI = exports.x_PI = undefined;

var _proj = __webpack_require__(49);

var _proj2 = _interopRequireDefault(_proj);

var _openlayers = __webpack_require__(32);
...
var _Style = _interopRequireWildcard(_style);
...
var parseCode = __webpack_require__(50);
...
var Feature = function () {
  function Feature(map, layer) {
    ...
    if (!this.map) {
      ...
      this.layer = layer || new _constants.Layer(this.map);
    }
  }
  ...
  _createClass(Feature, [{
    ...
    value: function getFeatureById2LayerName(id, layerName) {
      var feature = null;
      if (!!layerName) {
        var layer = this.layer.getLayerByName(layerName);
    ...
    value: function addPoint(point, params) {
      ...
      var style = _constants.Style.getStyleByPoint(point['attributes']);
      ...
      if (point['attributes'] && point['attributes']['id']) {
        var id = point['attributes']['id'] ? point['attributes']['id'] : point['attributes']['ID'] ? point['attributes']['ID'] : params['id'];
        feature.setId(id);
      ...
      if (params['layerName']) {
        var layer = this.layer.creatVectorLayer(params['layerName'], {
          create: true
        });
    ...
    value: function addPolyline(line, params) {
      ...
      var style = _constants.Style.getStyleByPoint(line['attributes']);
      var extent = linefeature.getGeometry().getExtent();
      if (style && linefeature) {
        linefeature.setStyle(style);
      }
      if (line.attributes['ID'] || line.attributes['id']) {
        var id = line['attributes']['id'] ? line['attributes']['id'] : line['attributes']['ID'] ? line['attributes']['ID'] : params['id'];
...
exports.getStyleByPoint = undefined;

var _constants = __webpack_require__(2);

var getStyleByPoint = exports.getStyleByPoint = function getStyleByPoint(attr) {
...
proj4.version = __webpack_require__(76);
...
var gauss = __webpack_require__(58);
var adjust_lon = __webpack_require__(0);
exports.init = function() {
...
var HMap = function () {
  ...
  _createClass(HMap, [{
    ...
    value: function _addModule() {
      ...
      this.feature = new _constants.Feature(this.map, this.layer);
    }
  }, {
    key: 'addPoint',
    value: function addPoint(point, params) {
      var feature = new _constants.Feature(this.map, this.layer);
