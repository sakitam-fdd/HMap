...
ol.control.ZoomMenu.prototype.initDomInternal_ = function (className, delta) {
  ...
  zoomout.innerHTML = '\u2212'
  Events.listen(zoomin, 'click', ol.control.ZoomMenu.prototype.handleClick_.bind(this, delta))
  Events.listen(zoomout, 'click', ol.control.ZoomMenu.prototype.handleClick_.bind(this, -delta))
  return element
}
