...
class Layer {
  ...
  getLayerByLayerName (layerName) {
    return LayerUtils.getLayerByLayerName(this.getMap(), layerName);
  }
  ...
  getLayerByKeyValue (key, value) {
    return LayerUtils.getLayerByKeyValue(this.getMap(), key, value);
  }
  ...
  getLayersArrayByKeyValue (key, value) {
    return LayerUtils.getLayersArrayByKeyValue(this.getMap(), key, value);
  }
   ...
   */
  getAllLayers () {
    return LayerUtils.getAllLayers(this.getMap());
  }
  ...
  getLayerByFeature (feature) {
    return LayerUtils.getLayerByFeature(this.getMap(), feature);
  }
  ...
  createVectorLayer (layerName, params) {
    ...
    return LayerUtils.createVectorLayer(this.getMap(), layerName, params);
  }
  ...
  createHeatMapLayer (layerName, params) {
    ...
    if (this.map) {
      ...
      if (!(currentLayer instanceof ol.layer.Heatmap)) {
        ...
        currentLayer instanceof ol.layer.Heatmap &&
  ...
  createTitleLayer (layerName, params) {
    ...
    if (
      ooLayer &&
      ooLayer instanceof ol.layer.Tile &&
      !(params['addLayer'] === false)
    ) {
  ...
  createImageWMSLayer (layerName, params) {
    ...
    if (!layer && params && params['layerUrl'] && params['create']) {
      layer = new ol.layer.Image({
        ...
        visible: params['visible'] === false ? params['visible'] : true,
        opacity:
          params['opacity'] && typeof params['opacity'] === 'number'
            ? params['opacity']
            : 1,
        zIndex: params['zIndex'],
  ...
  createWMTSLayer (layerName, params) {
    ...
    if (
      ...
      let projection = ol.proj.get(
        params['projection'] ? params['projection'] : 'EPSG:3857'
      );
      let projectionExtent = params['extent']
        ? params['extent']
    ...
    if (!layer && params && params['layerUrl'] && params['create']) {
      ...
      if (params['tileGrid'] && params['tileGrid']['resolutions']) {
        tileGrid = new ol.tilegrid.TileGrid({
          tileSize: tileSize,
          origin: params['tileGrid']['origin']
            ? params['tileGrid']['origin']
            : undefined,
          extent: params['tileGrid']['extent']
            ? params['tileGrid']['extent']
            : undefined,
          resolutions: params['tileGrid']['resolutions'],
          minZoom:
            params['tileGrid']['minZoom'] &&
            typeof params['tileGrid']['minZoom'] === 'number'
              ? params['tileGrid']['minZoom']
              : 0
        });
      }
      layer = new ol.layer.Tile({
        ...
        source: new ol.source.XYZ({
          ...
          tilePixelRatio: params['tilePixelRatio']
            ? params['tilePixelRatio']
            : 1, // todo 对于高分辨率设备，例如苹果等可能2、3（移动端开发需要注意）
          projection: projection,
      ...
      if (params['tileGrid']) {
        ...
        tileGrid = new ol.tilegrid.createXYZ({
          ...
          maxZoom:
            ...
            typeof params['tileGrid']['maxZoom'] === 'number'
              ? params['tileGrid']['maxZoom']
              : 22
        });
      }
      layer = new ol.layer.VectorTile({
        ...
        maxResolution:
          params['maxResolution'] && typeof params['maxResolution'] === 'number'
            ...
            : undefined,
        preload:
          params['preload'] && typeof params['preload'] === 'number'
            ? params['preload']
            : 0,
        source: new ol.source.VectorTile({
          ...
          tileGrid:
            tileGrid && tileGrid instanceof ol.tilegrid.TileGrid
              ? tileGrid
              : undefined,
          tilePixelRatio:
            params['tilePixelRatio'] &&
            typeof params['tilePixelRatio'] === 'number'
              ? params['tilePixelRatio']
              : 1,
          url: params['layerUrl'],
          wrapX: false
  ...
  _getTileGrid (params) {
    ...
    if (params['tileGrid']) {
      ...
      if (
        params['tileGrid']['tileSizes'] &&
        params['tileGrid']['tileSizes'].length ===
          params['tileGrid']['resolutions']
      ) {
      ...
      if (params['tileGrid']['gridType'] === 'XYZ') {
        ...
        tileGrid = new ol.tilegrid.WMTS({
          sizes:
            params['tileGrid']['sizes'] &&
            Array.isArray(params['tileGrid']['sizes'])
              ? params['tileGrid']['sizes']
              : undefined,
          widths:
            params['tileGrid']['widths'] &&
            Array.isArray(params['tileGrid']['widths'])
              ? params['tileGrid']['widths']
              : undefined,
          tileSize: tileSize,
          ...
          origin: params['tileGrid']['origin']
            ? params['tileGrid']['origin']
            : undefined,
          origins: params['tileGrid']['origins']
            ? params['tileGrid']['origins']
            : undefined,
          extent: params['tileGrid']['extent']
            ? params['tileGrid']['extent']
            : undefined,
  ...
  createVectorTileLayer (layerName, params) {
    ...
    if (
      !layer &&
      params &&
      (params['layerUrl'] || params['layerUrls']) &&
      params['create']
    ) {
      let projection = 'EPSG:3857';
      if (params['projection']) {
      ...
      layer = new ol.layer.VectorTile({
        ...
        source: new ol.source.VectorTile({
          ...
          cacheSize:
            params['cacheSize'] && typeof params['cacheSize'] === 'number'
              ? params['cacheSize']
              : 128,
          crossOrigin: params['crossOrigin']
            ? params['crossOrigin']
          ...
          overlaps: params['overlaps'] ? params['overlaps'] : true,
          tileClass:
            params['tileClass'] && typeof params['tileClass'] === 'function'
              ? params['tileClass']
              : ol.VectorTile,
          ...
          urls:
            params['layerUrls'] &&
            Array.isArray(params['layerUrls']) &&
            params['layerUrls'].length > 0
              ? params['layerUrls']
              : undefined,
          tileUrlFunction:
            params['tileUrlFunction'] &&
            typeof params['tileUrlFunction'] === 'function'
              ? params['tileUrlFunction']
              : undefined,
          tileLoadFunction:
            params['tileLoadFunction'] &&
            typeof params['tileLoadFunction'] === 'function'
              ? params['tileLoadFunction']
              : undefined,
          wrapX: false
        }),
      ...
      case 'ImageMapGuide':
        source = new ol.source.ImageMapGuide({
          ...
          metersPerUnit:
            ...
            typeof params['metersPerUnit'] === 'number'
              ? params['metersPerUnit']
              : 1,
          hidpi:
            params['hidpi'] && typeof params['hidpi'] === 'boolean'
              ? params['hidpi']
              : true,
          useOverlay:
          ...
          ratio:
            params['ratio'] && typeof params['ratio'] === 'number'
              ? params['ratio']
              : 1,
          resolutions:
          ...
          imageLoadFunction:
            ...
            typeof params['imageLoadFunction'] === 'function'
              ? params['imageLoadFunction']
              : undefined,
          params:
