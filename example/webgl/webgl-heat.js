...
textureFloatShims = function () {
  ...
  checkFloatLinear = function (gl, sourceType) {
    var buffer, cleanup, fragmentShader, framebuffer, positionLoc, program, readBuffer, result, source, sourceCanvas,
      sourceLoc, target, vertexShader, vertices;
  ...
  if (window.WebGLRenderingContext != null) {
    ...
    return WebGLRenderingContext.prototype.getFloatExtension = function (spec) {
      var candidate, candidates, half, halfFramebuffer, halfLinear, halfTexture, i, importance, preference, result,
        single, singleFramebuffer, singleLinear, singleTexture, use, _j, _k, _l, _len1, _len2, _len3, _len4, _m, _ref,
...
WebGLHeatmap = (function () {
  ...
  function WebGLHeatmap (_arg) {
    var alphaEnd, alphaRange, alphaStart, getColorFun, gradientTexture, image, intensityToAlpha, output, quad,
      textureGradient, _ref, _ref1, _ref2, _ref3;
...
const createWebGLHeatmap = function (params) {
